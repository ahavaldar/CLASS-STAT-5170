...
# The following code uses the user-defined functions defined at the top of this set of examples to calculate assessments of predictive performance and to check whether the model adequately accounts for autocorrelations. The four models to be compared are listed as follows. 
...
#
# x.pred(n+1;n) = (1-lambda)*x(n) + lambda*x.pred(n;n-1) + delta
#
# and then
#
