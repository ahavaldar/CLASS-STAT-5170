...
x.vect <- as.matrix(14.1, 16.4, 18.1, 35.5, 43.7, 45.8, 50.4, 46.9, 45.9, 44.4, 37.7)
Z.mat <- as.matrix(cbind(rep(x=1, times=11), std.time))
...
x.vect <- as.matrix(c(14.1, 16.4, 18.1, 35.5, 43.7, 45.8, 50.4, 46.9, 45.9, 44.4, 37.7))
Z.mat <- as.matrix(cbind(rep(x=1, times=11), std.time))
colnames(Z.mat) <- c("z0", "z1")
ls.stat <- reg.summary(x.vect, Z.mat)
...
Z.mat <- as.matrix(cbind(rep(x=1, times=2), std.time)) #, std.time ^2, std.time ^3))
colnames(Z.mat) <- c("z0", "z1")# "z2", "z3")

model.parms <- list()
model.parms$x.vect <- c(14.1, 16.4, 18.1, 35.5, 43.7, 45.8, 50.4, 46.9, 45.9, 44.4, 37.7)
comp.parms <- list()
